...
( function ( $, mw ) {
	...
	mw.loader.using( [ 'ext.smile.timeline', 'ext.smile.timeline.core' ] ).then( () => {
...
function smwAddEvent( evspan, evs ) {
	...
	let prefix = '';
	let postfix = '';
	let icon = Timeline.urlPrefix + 'images/dull-blue-circle.png';
	...
	const parseDateTimeFunction = evs._events.getUnit().getParser( 'iso8601' );
	const evt = new Timeline.DefaultEventSource.Event(
