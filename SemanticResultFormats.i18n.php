...
$messages['ru'] = array(
	...
	'prefs-srf' => 'Форматы семантических результатов',
	'srf-prefs-intro-text' => 'У вас установлено расширение "форматы семантических результатов", которое на данный момент не содержит настраиваемых пользователем параметров. Для получения помощи, пожалуйста, посетите страницу [http://www.semantic-mediawiki.org/wiki/Help:Result_formats фоматы результатов].',
