...
$messages['en'] = array(
	...
	'prefs-srf-datatables-options' => '{{INT:srf-printername-datatables}} options',
...
$messages['qqq'] = array(
	...
	'prefs-srf-datatables-options-options' => 'This is a section header text on [[Special:Preferences#mw-prefsection-smw|Special:Preferences]].',
	...
	'srf-prefs-datatables-options-cache-default' => 'This is an user preference that belongs to the DataTables [[Special:Preferences#mw-prefsection-smw|Special:Preferences]].',
...
This is an alias of "tree" {{msg-mw|Srf printername tree}}.',
	...
	'srf-rootinvalid' => 'This is an error message. See result format [http://semantic-mediawiki.org/wiki/Help:Tree_format tree] for further information.',
...
{{doc-important|Do not translate <code>zero</code>}}',
	...
	'srf-ui-datatables-label-conditions' => '{{doc-smw-ui-label|conditions}}',
	...
	'srf-ui-datatables-label-sInfoFiltered' => '{{doc-smw-ui-label|sInfoFiltered}}',
	'srf-ui-datatables-label-sInfoPostFix' => '{{doc-smw-ui-label|sInfoPostFix}}',
	'srf-ui-datatables-label-sInfoThousands' => '{{doc-smw-ui-label|sInfoThousands}}',
	'srf-ui-datatables-label-sLengthMenu' => '{{doc-smw-ui-label|sLengthMenu}}',
	'srf-ui-datatables-label-sLoadingRecords' => '{{doc-smw-ui-label|sLoadingRecords}}',
	'srf-ui-datatables-label-sProcessing' => '{{doc-smw-ui-label|sProcessing}}',
	'srf-ui-datatables-label-sSearch' => '{{doc-smw-ui-label|sSearch}}',
	'srf-ui-datatables-label-sZeroRecords' => '{{doc-smw-ui-label|sZeroRecords}}',
	'srf-ui-datatables-label-oPaginate-sFirst' => '{{doc-smw-ui-label|oPaginate-sFirst}}',
	'srf-ui-datatables-label-oPaginate-sLast' => '{{doc-smw-ui-label|oPaginate-sLast}}',
	'srf-ui-datatables-label-oPaginate-sNext' => '{{doc-smw-ui-label|oPaginate-sNext}}',
	'srf-ui-datatables-label-oPaginate-sPrevious' => '{{doc-smw-ui-label|oPaginate-sPrevious}}',
	'srf-ui-datatables-label-oAria-sSortAscending' => '{{doc-smw-ui-label|oAria-sSortAscending}}',
	'srf-ui-datatables-label-oAria-sSortDescending' => '{{doc-smw-ui-label|oAria-sSortDescending}}',
	'srf-ui-datatables-label-multiselect-column-header' => '{{doc-smw-ui-label|multiselect-column-header}}',
...
$messages['de'] = array(
	...
	'srf-prefs-intro-text' => 'Du hast die Programmerweiterung „Semantic Result Formats“ installiert. Besuch bitte die [https://www.semantic-mediawiki.org/wiki/Help:Ergebnisformate Hilfeseite zu Ergebnisformaten] für weitere Informationen.',
	...
	'srf_printername_datatables' => 'Tabelle (Datentabelle)',
	...
	'srf-ui-datatables-label-content-cache' => 'Der Inhalt stammt vom lokalen Zwischenspeicher.',
	'srf-ui-datatables-label-content-server' => 'Der Inhaltn stammt vom Datenbankserver.',
	...
	'srf-ui-datatables-label-placeholder-column-search' => 'Suche …',
	'srf-ui-datatables-label-sEmptyTable' => 'In der Datentabelle werden keine Daen angezeigt',
...
$messages['de-formal'] = array(
	'srf-prefs-intro-text' => 'Sie haben die Programmerweiterung „Semantic Result Formats“ installiert. Besuchen Sie bitte die [https://www.semantic-mediawiki.org/wiki/Help:Ergebnisformate Hilfeseite zu Ergebnisformaten] für weitere Informationen.',
...
$messages['es'] = array(
	...
	'srf-paramdesc-datasource' => 'La fuente en la que están accesibles los datos. Valores permitidos: file, raw y url. Por defecto: file',
...
$messages['et'] = array(
	...
	'srf_printername_average' => 'Arvude keskmise',
...
$messages['fi'] = array(
	...
	'srf-paramdesc-calendarstart' => 'Kalenterin alkupäivämäärä', # Fuzzy
...
$messages['pms'] = array(
	...
	'srf-prefs-intro-text' => "It l'has anstalà l'estension Formà dj'Arzultà Semàntich che al moment a l'ha gnun-e opsion utent përsonalisabij. Për assistensa, për piasì vìsita la pagina d'agiut [http://www.semantic-mediawiki.org/wiki/Help:Result_formats format d'arzultà]",
	'srf-module-loading' => 'A caria ...',
	'srf-paramdesc-layout' => 'Layout disponìbij',
	'srf-paramdesc-height' => 'Autëssa',
	'srf-paramdesc-width' => 'Larghëssa',
	'srf-paramdesc-class' => 'Specìfica na class adissional ëd cascading style sheet',
	'srf-module-nomatch' => 'A-i é pa gnun-a ròba parej',
	...
	'srf-ui-common-label-ajax-error' => "Ël sërvent a l'ha arportà na comunicassion falìa për sto $1. Për piasì preuva a rinfrësché la pagina o consulta con sto $2.",
	'srf-ui-common-label-request-object' => 'ciama ogèt',
	'srf-ui-common-label-help-section' => "session d'agiut",
	'srf-ui-tooltip-title-options' => 'Opsion',
	'srf-ui-tooltip-title-scope' => 'But',
	'srf-error-option-mix' => "L'opsion ($1) a l'é pa disponìbila",
	'srf-error-option-link-all' => 'L\'opsion ($1) a veul che ël paràmetr "link" a sia ampostà a "all"',
	'srf-error-missing-layout' => 'Layout mancant',
	'srf-warn-empy-chart' => "La tabela o ël gràfich a l'é veuid a causa ëd dat mancant",
	...
	'srf_paramdesc_calendarcolors' => 'Ël color da mosté për minca propietà dla data (esempi: "Start date=>green,End date=>#09c")',
	...
	'srf-paramdesc-default' => 'Valor predefinì che a sarà mostà quand a-i é gnun arzultà numérich',
	'srf_printername_earliest' => 'Prima ora',
	'srf_printername_latest' => 'Ultima ora',
	...
	'srf-timeline-allresults' => "Autr arzultà për st'arserca-sì.",
	'srf-timeline-nojs' => 'It deuve avèj JavaScript abilità për vëdde la bara dij temp anterativa.',
	...
	'srf-printername-jqplotseries' => 'serie jqPlot',
	'srf_paramdesc_chartheight' => "Specìfica l'autëssa (an pixel) dël gràfich o dël diagrama",
	'srf_paramdesc_chartwidth' => 'Specìfica la larghëssa (an pixel o përsent) del gràfich o dël diagrama',
	...
	'srf-paramdesc-ticklabels' => 'Abìlita visualisassion dle tichëtte da sponté',
	'srf-paramdesc-minvalue' => "Ël valor mìnim da mosté dzor l'ass Y",
	'srf-paramdesc-pointlabels' => 'Mosta ij pont dat an gràfich',
	'srf-paramdesc-chartlegend' => 'Posission legenda dël gràfich',
	'srf-paramdesc-datalabels' => 'Tichëtte dat dël gràfich/diagrama',
	'srf-paramdesc-charttext' => 'Test descritiv dël gràfich',
	'srf-paramdesc-chartclass' => 'Class adissional ëd CSS',
	'srf-paramdesc-renderer' => 'Selession-a un visualisador ëd diagrama/gràfich',
	'srf-paramdesc-filling' => 'Opsion andividual dë riempiment',
	'srf-paramdesc-theme' => 'Selession-a un tema ëd grija',
	'srf-paramdesc-chartcolor' => 'Assigna color andividuaj ëd gràfich',
	...
	'srf-paramdesc-highlighter' => "Mosta n'evidensiador ëd pont dat",
	'srf-paramdesc-smoothlines' => "Aplica n'algoritm ëd livelament dzor ël grafich a linie",
	'srf-paramdesc-stackseries' => 'Mosta gràfich aom serie ëd pile',
	'srf-paramdesc-seriesgroup' => 'Selession-a ragrupament ëd serie',
	...
	'srf-paramdesc-trendline' => 'Abìlita visualisassion simultanee dël gràfich e dla soa linia ëd tendensa',
	'srf-paramdesc-gridview' => 'Mosta gràfich e serie ëd dat simultaneament. Valor përmëttù: gnun e tab. Predefinì: gnun.',
	'srf-paramdesc-infotext' => "Mosta anformassion adissionaj dzor un tab d'anformassion corispondent",
	'srf-ui-gridview-label-item' => 'element dat',
	...
	'srf_paramdesc_fileextensions' => "Quand as dòvra ël nòm archivi com didascalìa, mosta ëdcò l'estension d'archivi",
	'srf_paramdesc_captionproperty' => 'Ël nòm ëd na propietà semàntica present dzor le pagine ciamà da dovré com didascalìa',
	'srf_paramdesc_imageproperty' => "Ëll nòm ëd na propietà semantica dzor le pagine ciamà ch'a ponta a figure da dovré. Quand ampostà, le pagine ciamà mideme a saran pa mostà com figure",
	'srf-paramdesc-redirects' => "Ëll nòm ëd na propietà semantica present dzor le pagine ciamà ch'a conten la destinassion ëd rediression",
	'srf-paramdesc-navigation' => 'Control ëd navigassion dël layout',
	'srf-paramdesc-overlay' => 'Abìlita covertura dla figura',
	...
	'srf-paramdesc-excludetags' => 'Gava tichëtte (delimitador: ;)',
	...
	'srf_paramdesc_hidegaps' => "S'a venta smon-e na propietà ciamà dë stampé ma pa disponibla e argistré ij valor separà da 'd separator o lassela fòra",
	'srf_paramdesc_arrayname' => "Se dàit e si ArrayEstension a l'é disponìbil sòn a creerà na tàula con ij nòm ëspessìfich (gnun-a stampa visibla antlora)",
	...
	'srf_paramdesc_headersep' => 'Separador tra nòm propietà e valor se "headers" a l\'é ampostà a "show" o "plain"',
	'srf_printername_hash' => 'Taj',
	'srf_paramdesc_hashname' => "Se dàit e l'estension HashTables a l'é disponìbil sòn a creerà un taj con ël nòm ëspessìfich (gnun-a stampa visibla antlora)",
	...
	'srf_printername_datatables' => 'DataTables',
	'srf-paramdesc-rowindex' => 'Indes ëd riga ëd tabela',
	'srf-paramdesc-displaylength' => 'Lunghëssa inissial dla visualisassion',
	'srf_printername_tree' => 'Erbo',
	'srf_printername_ultree' => 'Ultree',
	'srf_printername_oltree' => 'Oltree',
	'srf-noparentprop' => "Gnun-a propietà genitris dàita. L'erbo a peul pa esse fàit sensa na propietà genitris specificà.",
	'srf-paramdesc-parent' => 'La propietà a conten la pagina genitris',
	'srf-printername-slideshow' => 'SlideShow',
	'srf-paramdesc-delay' => "L'artard tra diapositive an second",
	'srf-paramdesc-navigation-controls' => 'Mosté ij contròj ëd navigassion o nò',
	'srf-paramdesc-effect' => "L'efet da dovré për cangé da diapositiva a diapositiva",
	...
	'srf-paramdesc-filtered-filter-position' => 'La posission dij filtr an relassion a le visualisassion, Valor përmëttù: testa, pé. Predefin^: testa.',
	'srf-paramdesc-filtered-list-type' => 'La sòrt ëd lìa lista. valor përmëttù: list, ul, ol. Predefinì: list.',
	'srf-paramdesc-filtered-list-template' => 'Lë stamp da dovré për formaté le vos dla lista.',
	'srf-paramdesc-filtered-list-named-args' => "Nòmina j'argoment passà a lë stamp.",
	'srf-paramdesc-filtered-list-introtemplate' => "Ël nòm ëd në stamp da mostré prima dj'arzultà dl'arserca, s'a-i në j'é.",
	'srf-paramdesc-filtered-list-outrotemplate' => "Ël nòm ëd në stamp da mostré apress ëd j'arzultà dl'arserca, s'a-i në j'é.",
	'srf-paramdesc-filtered-calendar-start' => "La stampa contenent la data inissial d'un event",
	'srf-paramdesc-filtered-calendar-end' => "La stampa content la data final d'un event",
	'srf-paramdesc-filtered-calendar-title' => "la stampa contenent ël tìtol d'un event. As peul pa dovresse ansem con në stamp ëd tìtol.",
	'srf-paramdesc-filtered-calendar-title-template' => "Në stamp dovrà pëfr formaté ël tìtol d'event ant ël calendari",
	'srf-filtered-selectorlabel-list' => 'Lista',
	...
	'srf-paramdesc-group' => 'Serie ragrupà për',
	'srf-paramdesc-zoom' => 'Abìlita zoom',
	'srf-paramdesc-datatable' => 'Abìlita na tabela dat',
	'srf-timeseries-zoom-out-of-range' => "L'antërval dë zoom a dà pa bastansa dat",
	'srf-printername-sparkline' => 'Gràfich dë sparkline',
	'srf-printername-listwidget' => 'Listwidget',
	'srf-paramdesc-listtype' => 'Specìfica la sòrt ëd lista',
	'srf-paramdesc-widget' => 'Widget disponìbij',
	...
	'srf-paramdesc-calendardefaultview' => 'La visualisassion inissial quans as caria ël calendari',
	'srf-paramdesc-calendarstart' => "L'inissi inissial dël calendari (data o valor ëd data e ora)",
	...
	'srf-paramdesc-datasource' => "La sorziss d'anté la data a l'é acessibla. Valor përmëttù: file, raw e url. Predefinì: file.",
	'srf-paramdesc-errorbar' => "La bara d'eror da dovré. Valor përmëttù: fraction (antërval ëd confidensa per ij valor), sigma (deviassion standard dij valor) e range (antërval ëd valor përsonalisà)",
	'srf-paramdesc-movingaverage' => 'Mosta la media dzora un nùmer ëd di (zero a andicherà gnun cangiament ëd media)',
	...
	'srf-printername-pagewidget' => 'Pagewidget',
	'srf-printername-incoming' => 'Propietà intrante',
	'srf-paramdesc-min' => 'Mìnim o valor ëd seuja',
	'srf-paramdesc-excludeproperty' => "Esclud propietà da l'ansem arzultà",
	'srf-printername-media' => 'Letor multimojen',
	'srf-paramdesc-mediainspector' => "A mosta dj'anformassion detajà a propòsit ëd n'element multimojen specificà",
	...
	'srf-ui-mediaplayer-label-shuffle' => 'Casual',
	'srf-ui-mediaplayer-label-shuffle-off' => 'Casual dëstiss',
	'srf-ui-mediaplayer-label-repeat' => 'Arpet',
	'srf-ui-mediaplayer-label-repeat-off' => 'Arpet dëstiss',
	'srf-ui-mediaplayer-label-full-screen' => 'Scren antregh',
	'srf-ui-mediaplayer-label-restore-screen' => 'Riprìstina scren',
);
...
$messages['pt-br'] = array(
	...
	'srf-paramdesc-gridview' => 'Exibe simultaneamente o gráfico e seus conjuntos de dados', # Fuzzy
	...
	'srf-paramdesc-calendarstart' => 'O começo do primeiro calendário', # Fuzzy
	...
	'srf-printername-dygraphs' => 'Gráfico Dygraphs',
	'srf-paramdesc-datasource' => 'Especificar a fonte em que os dados estão acessíveis (arquivo, URL, etc.)', # Fuzzy
	'srf-paramdesc-errorbar' => 'Especificar a barra de erro utilizada (desvio-padrão (sigma), frações em lote ou uma barra personalizada variando de valores low;middle;high)', # Fuzzy
	...
	'srf-ui-datatables-label-update-success' => 'A atualização da tabela obteve sucesso',
	'srf-ui-datatables-label-update-error' => 'A atualização da tabela falhou.',
	'srf-ui-datatables-label-placeholder-column-search' => '… mais resultados',
	...
	'srf-ui-datatables-label-sSearch' => 'Procura:',
...
$messages['ru'] = array(
	...
	'srf-name' => 'Semantic Result Formats',
	'prefs-srf' => 'Semantic Result Formats',
	'srf-prefs-intro-text' => 'У вас установлено расширение "Semantic Result Formats", которое на данный момент не содержит настраиваемых пользователем параметров. Для получения помощи, пожалуйста, посетите страницу [http://www.semantic-mediawiki.org/wiki/Help:Result_formats Result formats].',
	...
	'srf-ui-common-label-ajax-error' => 'Сервер сообщил о неудачной связи с $1. Пожалуйста, попробуйте обновить страницу или обратитесь с этим к $2.',
	...
	'srf_paramdesc_graphname' => 'Заголовок',
	...
	'srf-printername-media' => 'Медиа-проигрыватель',
	'srf-paramdesc-mediainspector' => 'Показывать детальную информацию об указанном медиа-элементе',
 ...
 */
$messages['si'] = array(
	'srf-name' => 'අර්ථ විචාර ප්‍රතිඑල ආකෘතීන්',
	...
	'srf_paramdesc_graphsize' => 'ප්‍රස්ථාරයේ ප්‍රමාණය (පික්සල් වලින්)',
	'srf_paramdesc_graphlegend' => 'රේඛාචිත්‍ර ප්‍රබන්ධය පෙන්වන්න හෝ එපා',
	'srf_paramdesc_graphlabel' => 'ප්‍රස්ථාර ලේබලය',
	'srf_paramdesc_rankdir' => 'ඊ නිර්දේශනය',
	'srf_paramdesc_graphlink' => 'ප්‍රස්තාර සබැඳිය',
	'srf_paramdesc_graphcolor' => 'ප්‍රස්තාර වර්ණය',
	'srf-paramdesc-graph-wwl' => 'වචන පොරෝන සීමාව (# අක්ෂර වලින්)',
	'srf_printername_datatables' => 'දත්තවගු',
	'srf-paramdesc-rowindex' => 'වගු රොඹ සුචිය',
	'srf-paramdesc-displaylength' => 'ආරම්භක සංදර්ශක දිග',
	'srf_printername_tree' => 'වෘක්ෂය',
	'srf_printername_ultree' => 'අල්ට්‍රි',
	'srf_printername_oltree' => 'ඔල්ට්‍රි',
	'srf-paramdesc-parent' => 'මාපිය පිටුව අන්තර්ගත වන වත්කම',
...
$messages['zh-hans'] = array(
	...
	'srf-ui-mediaplayer-label-stop' => '停止',
	'srf-ui-mediaplayer-label-mute' => '静音',
	'srf-ui-mediaplayer-label-unmute' => '取消静音',
	'srf-ui-mediaplayer-label-volume-max' => '最大音量',
