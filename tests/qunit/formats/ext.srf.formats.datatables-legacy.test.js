...
( function ( $, mw, srf ) {
	...
	QUnit.module( 'ext.srf.formats.datatablesLegacy', QUnit.newMwEnvironment() );
	...
	QUnit.test( 'instance', function ( assert ) {
		...
		assert.ok( datatables instanceof srf.formats.datatablesLegacy, pass + 'the srf.formats.datatables instance was accessible' );
