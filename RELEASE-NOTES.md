...
* Raised the minimum MediaWiki version from 1.39 to 1.43 ([1001](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1001)) (by @paladox)
* Raised the minimum Semantic MediaWiki version from 5.0 to 7.2 ([1077](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1077)) (by @paladox)
* Raised the minimum PHP version from 8.1 to 8.2 (by [gesinn.it](https://gesinn.it))
* Added support for MediaWiki 1.45 and 1.46 ([1076](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1076)) (by @paladox)

### Breaking Changes

* Renamed the `cursor` parameter of the `jqplotseries` format to `chartcursor`, as Semantic MediaWiki 7 reserves `cursor`; queries setting `cursor=` need updating ([1119](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1119)) (by [Professional Wiki](https://professional.wiki))
* Corrected the results of the `standarddeviation`, `samplestandarddeviation`, `quartillower`, `quartilupper`, `quartillower.exc`, `quartilupper.exc`, `interquartilerange`, `interquartilerange.exc`, `mode` and `variance` formats; wikis relying on the previous values will see different results ([1120](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1120)) (by [Professional Wiki](https://professional.wiki))
* Changed the structure of the `srfFilteredConfig` JavaScript variable of the `filtered` format; gadgets and user scripts reading it need updating ([1133](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1133)) (by [Professional Wiki](https://professional.wiki))
* Moved the `array`, `hash`, `calendar`, `eventcalendar` and `math` formats into the `SRF\` namespace with new class names (by [gesinn.it](https://gesinn.it))

### New Features and Enhancements

* Added the `map view layers` parameter to the `filtered` format for multiple base layers with a layer switcher, including custom layers defined via the Maps extension (Maps 13.1.x, or 14.2.0 and later) ([1133](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1133)) (by [Professional Wiki](https://professional.wiki))
* Added the `map view geojson` parameter to the `filtered` format for a GeoJSON overlay on the map view ([1133](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1133)) (by [Professional Wiki](https://professional.wiki))
* Roughly halved the client-side configuration payload of the `filtered` format ([1133](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1133)) (by [Professional Wiki](https://professional.wiki))
...
* Improved the `outline` format with CSS classes on its headings instead of inline styles ([915](https://github.com/SemanticMediaWiki/SemanticResultFormats/issues/915)) (by [gesinn.it](https://gesinn.it))
* Renamed the `manysep` parameter of the `array` and `hash` formats to `valuesep`, keeping `manysep` as an alias ([1122](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1122)) (by [Professional Wiki](https://professional.wiki))

### Bug Fixes

* Fixed the `filtered` format crashing on pages with more than one filtered query ([1052](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1052)) (by @thomas-topway-it)
* Fixed the `filtered` format crashing when used outside a regular page parse, such as on Special:Ask or via the REST API ([1147](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1147)) (by [gesinn.it](https://gesinn.it))
* Fixed the `filtered` format's distance filter throwing an error for results without a value for the distance property (by [gesinn.it](https://gesinn.it))
* Fixed the `filtered` format failing to show or hide rows missing from the page ([394](https://github.com/SemanticMediaWiki/SemanticResultFormats/issues/394)) (by [gesinn.it](https://gesinn.it))
* Fixed the `filtered` format's unique ID generation ([1029](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1029)) (by [gesinn.it](https://gesinn.it))
* Fixed the `filtered` format's use of the deprecated `$wgAmericanDates` global ([1030](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1030)) (by [gesinn.it](https://gesinn.it))
* Fixed the `filtered` format's `RequestContext` fallback and a missing JavaScript config variable (by [gesinn.it](https://gesinn.it))
* Fixed several `filtered` format bugs found by its new parser-HTML integration tests ([1023](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1023)) (by [gesinn.it](https://gesinn.it))
* Fixed the `gallery` format overlay and redirect scripts on current MediaWiki versions ([977](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/977)) (by @freephile)
* Fixed the `gallery` format showing a raw message marker instead of the "further results" link with Semantic MediaWiki 7 ([1136](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1136)) (by [gesinn.it](https://gesinn.it))
* Fixed the `graph` format crashing with more than 14 distinct edge predicates (by [gesinn.it](https://gesinn.it))
* Fixed the `graph` format's duplicate, missing and orphaned parameter descriptions ([1126](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1126)) (by [gesinn.it](https://gesinn.it))
* Fixed the `graph` format's deprecation notice for nodes without a label ([1125](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1125)) (by [gesinn.it](https://gesinn.it))
* Fixed the `graph` format creating, dropping or misassigning nodes and edges depending on the position of page-type printouts ([1127](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1127)) (by [gesinn.it](https://gesinn.it))
* Fixed the `graph` format ignoring an explicitly suppressed printout label such as `?Property=` ([1132](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1132)) (by [gesinn.it](https://gesinn.it))
* Fixed the `graph` format rendering `<br />` literally in node labels with the Diagrams extension ([1129](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1129)) (by [gesinn.it](https://gesinn.it))
* Fixed the `graph` format wrapping field values with a newline instead of a line break, and dropping single-character captions ([1142](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1142)) (by [gesinn.it](https://gesinn.it))
* Fixed the `eventcalendar` format nesting adjacent events inside one another, failing to render a single event, and never showing event icons ([1139](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1139)) (by [gesinn.it](https://gesinn.it))
* Fixed the `calendar` format's Julian leap-year calculation for BC years (by [gesinn.it](https://gesinn.it))
* Fixed a dynamic property deprecation notice in the `calendar` format on PHP 8.2 and later ([1036](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1036)) (by @paladox)
* Fixed the calendar legend widget never rendering on initial creation, and the legend and parameters widgets removing elements outside themselves on destroy ([1107](https://github.com/SemanticMediaWiki/SemanticResultFormats/issues/1107), [1102](https://github.com/SemanticMediaWiki/SemanticResultFormats/issues/1102)) (by [gesinn.it](https://gesinn.it))
* Fixed the `array` and `hash` formats skipping rows when page titles are hidden, among other defects ([1055](https://github.com/SemanticMediaWiki/SemanticResultFormats/issues/1055)) (by [gesinn.it](https://gesinn.it))
* Fixed the `array` format not detecting version 2.x of the Arrays extension ([1057](https://github.com/SemanticMediaWiki/SemanticResultFormats/issues/1057)) (by [gesinn.it](https://gesinn.it))
* Fixed invalid SQL JOIN order in the `datatables` SearchPanes with five or more OR values ([996](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/996)) (by @YvarRavy)
* Fixed `tableName()` usage in the `datatables` SearchPanes ([975](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/975)) (by @huaj1ng)
* Fixed the `datatables` format aborting the page render when the SearchPanes fail for one column ([1051](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1051)) (by @thomas-topway-it)
* Fixed the `datatables` format's Ajax filtering of keyword properties and its sliced result length ([1048](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1048)) (by @thomas-topway-it)
* Fixed the `slideshow` format's fatal error with Semantic MediaWiki 7, and the image `alt` attribute in the `carousel` format ([1035](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1035)) (by @paladox)
* Fixed the statistical and `carousel` format names showing as raw message keys on Special:Ask, and gave the statistical formats proper English names ([1047](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1047)) (by [Professional Wiki](https://professional.wiki))
* Fixed the `jqplotseries` format showing a "Malformed `cursor=` token" error on every chart with Semantic MediaWiki 7 ([1119](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1119)) (by [Professional Wiki](https://professional.wiki))
* Fixed the `tagcloud` format dropping text items without a link ([1050](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1050)) (by @thomas-topway-it)
* Fixed the `outline` format's fatal error on MediaWiki 1.45 and later (by [gesinn.it](https://gesinn.it))
* Fixed the `dygraphs` format's tooltips ([1020](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1020)) (by [gesinn.it](https://gesinn.it))
* Fixed a misspelled height property in the `googlepie` format ([1097](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1097)) (by @D-Groenewegen)
* Fixed month names in client-rendered dates following the content language instead of the interface language ([1041](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1041)) (by @alistair3149)
* Fixed the JavaScript query API throwing for printouts with a custom identifier ([1113](https://github.com/SemanticMediaWiki/SemanticResultFormats/issues/1113)) (by [gesinn.it](https://gesinn.it))
* Updated translations (by translatewiki.net community)

### Maintenance

* Added Phan static analysis to CI ([1007](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1007)) (by [gesinn.it](https://gesinn.it))
* Added ESLint to CI and fixed its findings across all formats ([1095](https://github.com/SemanticMediaWiki/SemanticResultFormats/issues/1095)) (by [gesinn.it](https://gesinn.it))
* Added a node-qunit test runner to CI, ported the legacy browser QUnit tests to it and extended the JavaScript test coverage of most formats (by [gesinn.it](https://gesinn.it))
* Added JSONScript integration tests for many formats ([1021](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1021), [1028](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1028), [1117](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1117)) (by [gesinn.it](https://gesinn.it), @D-Groenewegen)
* Added integration tests rendering the `graph` format through GraphViz, Diagrams and External Data ([1128](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1128), [1142](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1142)) (by [gesinn.it](https://gesinn.it))
* Added unit tests for the `array`, `graph` and statistical formats ([1005](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1005), [1120](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1120), [1127](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1127)) (by [gesinn.it](https://gesinn.it), [Professional Wiki](https://professional.wiki))
* Fixed the CI coverage upload, which had never included the PHP report (by [gesinn.it](https://gesinn.it))
* Bumped `d3` to 7.9.0, the npm dependencies of the `filtered` format and the PHP development dependencies (by [gesinn.it](https://gesinn.it), @dependabot)
* Changed the `data-values/geo` version constraint to `~4.0` ([1046](https://github.com/SemanticMediaWiki/SemanticResultFormats/pull/1046)) (by @paladox)
