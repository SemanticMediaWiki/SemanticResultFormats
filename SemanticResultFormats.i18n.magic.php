...
/** Georgian (ქართული) */
$magicWords['ka'] = [
	'calendarstartdate' => [ 0, 'კალენდრის_დაწყების_თარიღი' ],
	'calendarenddate' => [ 0, 'კალენდრის_დასრულების_თარიღი' ],
];

/** Korean (한국어) */
$magicWords['ko'] = [
	'calendarstartdate' => [ 0, '달력시작날짜' ],
	'calendarenddate' => [ 0, '달력끝날짜' ],
];

/** Macedonian (македонски) */
$magicWords['mk'] = [
	'calendarstartdate' => [ 0, 'почетенкалендарскидатум' ],
	'calendarenddate' => [ 0, 'краенкалендарскидатум' ],
];

/** Malayalam (മലയാളം) */
$magicWords['ml'] = [
	'calendarstartdate' => [ 0, 'കലണ്ടറിലെയാദ്യതീയതി' ],
	'calendarenddate' => [ 0, 'കലണ്ടറിലെയവസാനതീയതി' ],
];

/** Marathi (मराठी) */
$magicWords['mr'] = [
	'calendarstartdate' => [ 0, 'दिनदर्शिकारंभदिन', 'calendarstartdate' ],
	'calendarenddate' => [ 0, 'दिनदर्शिकासांगतादिन', 'calendarenddate' ],
];
...
$magicWords['sr-el'] = [
	'calendarstartdate' => [ 0, 'početnidatum', 'početni_datum' ],
