...
class SRF_FV_List extends SRF_Filtered_View {
	...
	public static function getParameters() {
		...
		$params['list view named args'] = new Parameter( 'list named args', Parameter::TYPE_BOOLEAN, false );
		$params['list view named args']->setMessage( 'srf-paramdesc-filtered-list-named-args' );

		$params['list view introtemplate'] = new Parameter( 'list introtemplate' );
		...
		$params['list view outrotemplate'] = new Parameter( 'list outrotemplate' );
