...
class SemanticResultFormats {
	...
	public static function onExtensionFunction() {
		...
		$formatClasses = [
			...
			'max' => 'SRF\Math',
			'median' => 'SRF\Math',
			'samplevariance' => 'SRF\Math',
			'variance' => 'SRF\Math',
			'standarddeviation' => 'SRF\Math',
			'samplestandarddeviation' => 'SRF\Math',
			'range' => 'SRF\Math',
			'quartillower' => 'SRF\Math',
			'quartilupper' => 'SRF\Math',
			'quartillower.exc' => 'SRF\Math',
			'quartilupper.exc' => 'SRF\Math',
			'interquartilerange' => 'SRF\Math',
			'interquartilerange.exc' => 'SRF\Math',
			'mode' => 'SRF\Math',
			'interquartilemean' => 'SRF\Math',
