...
class SemanticResultFormats {
	...
	public static function onExtensionFunction() {
		...
		$formatClasses = [
			...
			'calendar' => 'SRF\Calendar\Calendar',
			'eventcalendar' => 'SRF\Calendar\EventCalendar',
			'outline' => 'SRF\Outline\OutlineResultPrinter',
			'sum' => 'SRF\Math\Math',
			'product' => 'SRF\Math\Math',
			'average' => 'SRF\Math\Math',
			'min' => 'SRF\Math\Math',
			'max' => 'SRF\Math\Math',
			'median' => 'SRF\Math\Math',
			'samplevariance' => 'SRF\Math\Math',
			'variance' => 'SRF\Math\Math',
			'standarddeviation' => 'SRF\Math\Math',
			'samplestandarddeviation' => 'SRF\Math\Math',
			'range' => 'SRF\Math\Math',
			'quartillower' => 'SRF\Math\Math',
			'quartilupper' => 'SRF\Math\Math',
			'quartillower.exc' => 'SRF\Math\Math',
			'quartilupper.exc' => 'SRF\Math\Math',
			'interquartilerange' => 'SRF\Math\Math',
			'interquartilerange.exc' => 'SRF\Math\Math',
			'mode' => 'SRF\Math\Math',
			'interquartilemean' => 'SRF\Math\Math',
			...
			'array' => 'SRF\ArrayFormat\ArrayPrinter',
			'hash' => 'SRF\ArrayFormat\HashPrinter',
			'd3chart' => 'SRFD3Chart',
